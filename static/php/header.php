...
<div class="avatar-t">
<img src="/img/<?Php echo $user['photo'];?>" width="100%" height="100%" style="border-radius: 10px;"/>
</div>
</div>
</div>
...
<a href="editprofile"><li>Opções</li></a>
<li>Comunidades</li>
...
if (leftbar.style.width === "260px") {
        	 	leftbar.style.width = "84px";
        	 	document.getElementById("nanita").style = "display: none;";
        	 	document.getElementById("uaiii").style = "left: 6px;";
        	} else {
            	leftbar.style.width = "260px";
            	document.getElementById("nanita").style = "display: block;";
            	document.getElementById("uaiii").style = "left: 10px;";
      	 	 }
});
